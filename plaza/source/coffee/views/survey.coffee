...
class Plaza.Views.Survey extends Backbone.View
	...
	initialize: ->
		...
		@survey = new Plaza.Models.Survey({"_id": "56b60e72f5f9e96ffb235c64"})
		@survey.fetch()
	...
	submit_form: (e)->
		...
		@survey_answer = new Plaza.Models.SurveyAnswer()
		@survey_answer.local_storage = "survey_answer"
		@survey_answer.urlRoot = Plaza.settings.api + "surveys/" + @survey.id + "/answers"
		@survey_answer.save {
			answers: answers
		},
